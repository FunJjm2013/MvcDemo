...
namespace MVCDemo.Models
{
    ...
    public class Category
    {
        ...
        /// 链接地址
        /// </summary>
        [Display(Name ="链接地址",Description ="点击栏目是跳转到的连接地址，最多255个字符。")]
        [StringLength(255,ErrorMessage ="X")]
        public string LinkUrl { get; set; }
        /// <summary>
        /// 栏目排序
        /// </summary>
        [Display(Name ="栏目排序",Description ="针对同级栏目，数字越少顺序越靠前。")]
        [Required(ErrorMessage ="必填")]
        ...
        [StringLength(255,ErrorMessage = "必需少于{0}个字符")]
        public string RecordUnit { get; set; }
        /// <summary>
        /// 记录名称
        /// </summary>
        [Display(Name ="记录名称",Description ="记录数的名称：如“文章”、“新闻”、“教程”等。")]
        [StringLength(255,ErrorMessage = "必须少于{0}个字符")]
